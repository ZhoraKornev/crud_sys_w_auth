...
user_login.sql        | Подготовленный файл базы данных users с коментариями каждого поля
...
![screenshot of sample](http://forum.norma4.net.ua/photoplog/images/9110/1_users_man1.png) 
...
[![презентация](http://forum.norma4.net.ua/photoplog/images/9110/1_presentation.png)](https://youtu.be/tizmLVk7XZ0)
